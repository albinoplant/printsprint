...
const PROD_MESSAGING_ID = '1072760820029'
...
firebase.initializeApp({
  ...
  messagingSenderId: !STAGE_MESSAGING_ID || self.location.hostname.includes('printsprint-app') // eslint-disable-line no-undef
    ? PROD_MESSAGING_ID
    : STAGE_MESSAGING_ID
})
/* eslint-disable prettier/prettier */
...
messaging.setBackgroundMessageHandler(function (payload) {
  ...
  const notificationTitle = 'Printsprint'
